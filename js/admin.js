...
const AdminApp = (() => {
  ...
  function layout(active, title, lede, body) {
    const nav = [
      ...
      { id: "announcements", href: "#/manage/announcements", label: I18n.t("announcements"), icon: "✦" },
    ];
    return `
  ...
  function viewAdminHome() {
    ...
    return layout(
      ...
      <div class="admin-action-grid">
        ...
        <button type="button" class="admin-action-card" data-nav="#/manage/announcements">
  ...
  function viewAnnouncements() {
    return layout(
      ...
      <div class="admin-toolbar" style="margin-bottom:1rem">
        <button type="button" class="btn btn-primary" data-nav="#/manage/announcements/new">${esc(I18n.t("createAnnouncement"))}</button>
      </div>
      <section class="admin-panel">
  ...
  function viewAnnouncementCreate() {
    return layout(
      "announcements",
      ...
      `
      <div class="admin-toolbar" style="margin-bottom:1rem">
        <button type="button" class="btn btn-ghost btn-sm" data-nav="#/manage/announcements">← ${esc(I18n.t("announcementHistory"))}</button>
      </div>
  ...
  function resolve(parts, params) {
    ...
    if (section === "announcements" && id === "new") return viewAnnouncementCreate();
